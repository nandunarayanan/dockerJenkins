...
/** 
* 
*Function Name :password Class
*
* Description  : This class is used to declare the attributes and methods used in receiving, verifying and keeping the data password protected. 		   
* 
* Parameters   : None
* 
* Return Value : None
...
*
* Description  : This is the methos of class doctor. It is used to get the information about user's choice of department	 		   
* 
* Parameters   : None
* 
* Return Value : string
...
*
* Description  : This is n about user's choice of department	 		   
* 
* Parameters   : None
* 
* Return Value : string
